    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-10 offset-lg-1 text-center">
                ...
                <p class="heading-info">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Similique magni veniam maxime magnam dignissimos, explicabo facilis obcaecati fuga deserunt.</p>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
