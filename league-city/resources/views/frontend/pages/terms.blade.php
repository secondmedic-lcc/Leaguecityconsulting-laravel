        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="content">
                    ...
                    <ul>
                        <li>Upload or post any content that is harmful, obscene, defamatory, or otherwise objectionable.</li>
                        <li>Violate any applicable laws or regulations.</li>
                        <li>Infringe on the intellectual property rights of others.</li>
                        <li>Use the website for any unauthorized purpose.</li>
                    </ul>
                    <h2>Content Ownership</h2>
                    <p>The content on the website, including text, images, and videos, is protected by copyright and other intellectual property laws. You may not copy, reproduce, modify, or distribute any content without our express written permission.</p>
                    <h2>Disclaimer of Warranties</h2>
                    <p>We make no warranties or representations about the accuracy, completeness, or reliability of the content on the website. The website is provided "as is" and without warranties of any kind, express or implied.</p>
                    <h2>Limitation of Liability</h2>
                    <p>We will not be liable for any damages arising out of or in connection with your use of the website.</p>
                    <h2>Dispute Resolution</h2>
                    <p>Any disputes arising out of or in connection with these Terms of Use will be resolved by arbitration in accordance with the rules of the American Arbitration Association.</p>
                </div>
            </div>
        </div>
    </div>
