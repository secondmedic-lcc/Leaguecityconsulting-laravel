    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                ...
                <p class="heading-info">Consulting solutions priced to match your business complexity—scalable, strategic, and results-oriented.</p>
            </div>
        </div>
        <div class="row g-3 g-md-5 justify-content-center">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="box">
                    ...
                    <ul class="list">
                        <li class="mb-4">Main Points</li>
                        <li><i class="fas fa-check-circle text-success"></i> Tailored functionality to business needs</li>
