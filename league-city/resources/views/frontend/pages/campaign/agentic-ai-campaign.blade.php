                    ...
                    <form action="{{ route('campaign.store') }}" method="post" id="campaign-form" autocomplete="off">
                        ...
                        <div class="form-floating mb-3">
                            <input type="email" class="form-control" id="floatingInput2" placeholder="email"
                                name="email" onpaste="return false;" oncopy="return false;" />
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="floatingInput3" placeholder="number"
                                ...
                                onpaste="return false;" oncopy="return false;" pattern="[6-9]{1}[0-9]{9}"
                                name="contact" />
                ...
                <div class="owl-carousel campaign-review-slider">
                    <div class="item">
                        <div class="content-box-outer">
                            ...
                            <div class="content-box">
                                <p>
                                    I cannot recommend LeagueCity Consulting enough. Their team of experts are top-notch
                                    and provide exceptional IT solutions and support to their clients.
                                </p>
                            </div>
                    ...
                    <div class="item">
                        <div class="content-box-outer">
                            ...
                            <div class="content-box">
                                <p>
                                    What I appreciated most about LeagueCity Consulting was their personalized approach.
                                    They truly care about their clients and go above and beyond to ensure that you
                    ...
                    <div class="item">
                        <div class="content-box-outer">
                            ...
                            <div class="content-box">
                                <p>
                                    The process was incredibly easy and straightforward. I was connected with a highly
                                    qualified IT Professional who took the time to review my requirements and provide me
                                    with best service.
                                </p>
                            </div>
                            <div class="cust-img-box">
                    ...
                    <div class="item">
                        <div class="content-box-outer">
                            ...
                            <div class="content-box">
                                <p>
                                    LeagueCity Consulting provided exceptional service, guiding us through a seamless
                                    transition to a more robust IT system. Their team is knowledgeable, responsive, and
                    ...
                    <div class="item">
                        <div class="content-box-outer">
                            ...
                            <div class="content-box">
                                <p>
                                    Choosing LeagueCity Consulting was one of the best decisions for our company. Their
                                    innovative solutions and prompt support have greatly enhanced our productivity. We
                                    couldn't be happier!
                                </p>
                            </div>
                            <div class="cust-img-box">
                    ...
                    <div class="item">
                        <div class="content-box-outer">
                            ...
                            <div class="content-box">
                                <p>
                                    LeagueCity Consulting transformed our IT infrastructure. Their expertise and
                                    proactive approach have significantly improved our system's efficiency and security.
                                    Highly recommend!
                                </p>
                            </div>
                            <div class="cust-img-box">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            ...
                            <p>RRVM is a school management app that simplifies academic and administrative tasks with
                                ease.</p>
                            <button data-bs-toggle="modal" data-bs-target="#rrvmModal" class="btn web-btn">Click
                                Here</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="box"
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            ...
                            <button data-bs-toggle="modal" data-bs-target="#jkModal" class="btn web-btn">Click
                                Here</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="box" style="background-image: url('{{ asset('includes-frontend') }}/images/uyp.jpg')">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            ...
                            <button data-bs-toggle="modal" data-bs-target="#uypModal" class="btn web-btn">Click
                                Here</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="box"
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            ...
                            <button data-bs-toggle="modal" data-bs-target="#fandoraModal" class="btn web-btn">Click
                                Here</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="box"
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            ...
                            <button data-bs-toggle="modal" data-bs-target="#cctvModal" class="btn web-btn">Click
                                Here</button>
                        </div>
                    </div>
                </div>
...
<section class="pricing section-padding pb-0" id="pricing">
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <h2 class="section-heading with-p">Power Up Your Tech — Priced to Perform</h2>
                <p class="heading-info">Consulting solutions priced to match your business complexity—scalable,
                    strategic, and results-oriented.</p>
            </div>
        </div>
        <div class="row g-3 g-md-5 justify-content-center">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="box">
                    ...
                    <ul class="list">
                        ...
                        <li><i class="fas fa-check-circle text-success"></i> Custom, brand-aligned design</li>
                        <li><i class="fas fa-check-circle text-success"></i> Mobile-friendly and responsive</li>
                        <li><i class="fas fa-check-circle text-success"></i> Fast and optimized performance</li>
                        <li><i class="fas fa-check-circle text-success"></i> Secure with best-practice protection</li>
                        <li><i class="fas fa-check-circle text-success"></i> SEO-ready structure</li>
                    </ul>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="box">
                    <h3 class="box-heading">Custom Web Application</h3>
                    <p><b>Starting from 1299 SGD</b></p>
                    <p>EXCLUSIVE OF ALL TAXES</p>
                    <ul class="list">
                        <li class="mb-4">Main Points</li>
                        <li><i class="fas fa-check-circle text-success"></i> Tailored functionality to business needs
                        </li>
                        <li><i class="fas fa-check-circle text-success"></i> Scalable and secure architecture</li>
                        <li><i class="fas fa-check-circle text-success"></i> User-friendly interface</li>
                        <li><i class="fas fa-check-circle text-success"></i> Integration with third-party tools</li>
                        <li><i class="fas fa-check-circle text-success"></i> Ongoing maintenance available</li>
                    </ul>
                    <p class="small-text"><a href="#campaign-form" target="_blank">T&C Apply</a></p>
                    <a href="#campaign-form" class="btn web-btn btn-form">Get Started Now</a>
                </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="box">
                    <h3 class="box-heading">Ecommerce</h3>
                    <p><b>Starting from 1199 SGD</b></p>
                    <p>EXCLUSIVE OF ALL TAXES</p>
                    <ul class="list">
                        <li class="mb-4">Main Points</li>
                        <li><i class="fas fa-check-circle text-success"></i> Custom storefront design</li>
                        <li><i class="fas fa-check-circle text-success"></i> Secure payment gateway integration</li>
                        <li><i class="fas fa-check-circle text-success"></i> Inventory & order management</li>
                        <li><i class="fas fa-check-circle text-success"></i> SEO and performance optimized</li>
                        <li><i class="fas fa-check-circle text-success"></i> Mobile-responsive layout</li>
                    </ul>
                    <p class="small-text"><a href="#campaign-form" target="_blank">T&C Apply</a></p>
                    <a href="#campaign-form" class="btn web-btn btn-form">Get Started Now</a>
                </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="box">
                    <h3 class="box-heading">ERP</h3>
                    <p><b>Starting from 1999 SGD</b></p>
                    <p>EXCLUSIVE OF ALL TAXES</p>
                    <ul class="list">
                        <li class="mb-4">Main Points</li>
                        <li><i class="fas fa-check-circle text-success"></i> Custom module development</li>
                        <li><i class="fas fa-check-circle text-success"></i> Scalable business process automation</li>
                        <li><i class="fas fa-check-circle text-success"></i> Role-based access controls</li>
                        <li><i class="fas fa-check-circle text-success"></i> Real-time reporting and analytics</li>
                        <li><i class="fas fa-check-circle text-success"></i> Integration with existing tools</li>
                    </ul>
                    <p class="small-text"><a href="#campaign-form" target="_blank">T&C Apply</a></p>
                    <a href="#campaign-form" class="btn web-btn btn-form">Get Started Now</a>
                </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="box">
                    <h3 class="box-heading">Hybrid App</h3>
                    <p><b>Starting from 1499 SGD</b></p>
                    <p>EXCLUSIVE OF ALL TAXES</p>
                    <ul class="list">
                        <li class="mb-4">Main Points</li>
                        <li><i class="fas fa-check-circle text-success"></i> Cross-platform development</li>
                        <li><i class="fas fa-check-circle text-success"></i> Native-like performance</li>
                        <li><i class="fas fa-check-circle text-success"></i> Fast deployment cycle</li>
                        <li><i class="fas fa-check-circle text-success"></i> Device feature access</li>
                        <li><i class="fas fa-check-circle text-success"></i> Budget-friendly approach</li>
                    </ul>
                    <p class="small-text"><a href="#campaign-form" target="_blank">T&C Apply</a></p>
                    <a href="#campaign-form" class="btn web-btn btn-form">Get Started Now</a>
                </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="box">
                    <h3 class="box-heading">Native Android App</h3>
                    <p><b>Starting from 1499 SGD</b></p>
                    <p>EXCLUSIVE OF ALL TAXES</p>
                    <ul class="list">
                        <li class="mb-4">Main Points</li>
                        <li><i class="fas fa-check-circle text-success"></i> Built in Kotlin/Java</li>
                        <li><i class="fas fa-check-circle text-success"></i> Full Play Store support</li>
                        <li><i class="fas fa-check-circle text-success"></i> Optimized for performance</li>
                        <li><i class="fas fa-check-circle text-success"></i> Custom UI/UX design</li>
                        <li><i class="fas fa-check-circle text-success"></i> API & backend integration</li>
                    </ul>
                    <p class="small-text"><a href="#campaign-form" target="_blank">T&C Apply</a></p>
                    <a href="#campaign-form" class="btn web-btn btn-form">Get Started Now</a>
                </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="box">
                    <h3 class="box-heading">Native iOS App</h3>
                    <p><b>Starting from 1499 SGD</b></p>
                    <p>EXCLUSIVE OF ALL TAXES</p>
                    <ul class="list">
                        <li class="mb-4">Main Points</li>
                        <li><i class="fas fa-check-circle text-success"></i> Developed in Swift/Objective-C</li>
                        <li><i class="fas fa-check-circle text-success"></i> App Store submission support</li>
                        <li><i class="fas fa-check-circle text-success"></i> Smooth UI and performance</li>
                        <li><i class="fas fa-check-circle text-success"></i> Native iOS features integration</li>
                        <li><i class="fas fa-check-circle text-success"></i> Secure and scalable</li>
                    </ul>
                    <p class="small-text"><a href="#campaign-form" target="_blank">T&C Apply</a></p>
                    <a href="#campaign-form" class="btn web-btn btn-form">Get Started Now</a>
                </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="box">
                    <h3 class="box-heading">Digital Marketing</h3>
                    <p><b>Starting from 199 SGD</b></p>
                    <p>EXCLUSIVE OF ALL TAXES</p>
                    <ul class="list">
                        <li class="mb-4">Main Points</li>
                        <li><i class="fas fa-check-circle text-success"></i> SEO & content marketing</li>
                        <li><i class="fas fa-check-circle text-success"></i> Social media management</li>
                        <li><i class="fas fa-check-circle text-success"></i> Paid advertising (Google/Facebook)</li>
                        <li><i class="fas fa-check-circle text-success"></i> Email and lead campaigns</li>
                        <li><i class="fas fa-check-circle text-success"></i> Monthly analytics reports</li>
                    </ul>
                    <p class="small-text"><a href="#campaign-form" target="_blank">T&C Apply</a></p>
                    <a href="#campaign-form" class="btn web-btn btn-form">Get Started Now</a>
                </div>
                ...
                <div class="box">
                    ...
                    <ul class="list">
                        ...
                        <li>
                            ...
                            <p>Custom, brand-aligned design</p>
                        </li>
                        <li>
                            <i class="fas fa-check-circle text-success"></i>
                        ...
                        <li>
                            <i class="fas fa-check-circle text-success"></i>
                            <p>Secure with best-practice protection</p>
                        </li>
                        <li>
                            <i class="fas fa-check-circle text-success"></i>
...
<a href="https://api.whatsapp.com/send/?phone=+601127568048&text=Hello%20LeagueCity%20Consulting,%20I%20need%20help%20with:"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="owl-carousel app-screenshot-slider">
                    <div class="item">
                        <img src="{{ asset('includes-frontend') }}/images/secondmedic/secmed1.webp"
                            alt="Application">
                    </div>
                    <div class="item">
                        <img src="{{ asset('includes-frontend') }}/images/secondmedic/secmed2.webp"
                            alt="Application">
                    </div>
                    <div class="item">
                        <img src="{{ asset('includes-frontend') }}/images/secondmedic/secmed3.webp"
                            alt="Application">
                    </div>
                    <div class="item">
                        <img src="{{ asset('includes-frontend') }}/images/secondmedic/secmed4.webp"
                            alt="Application">
                    </div>
                    <div class="item">
                        <img src="{{ asset('includes-frontend') }}/images/secondmedic/secmed5.webp"
                            alt="Application">
                    </div>
                </div>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="owl-carousel app-screenshot-slider">
                    ...
                    <div class="item">
                        <img src="{{ asset('includes-frontend') }}/images/vivavalet/vivavalet5.webp"
                            alt="Application">
                    </div>
                </div>
            </div>
...
<div class="modal fade app-screenshot-modal" id="jkModal" tabindex="-1" aria-labelledby="jkModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header pb-0">
...
<div class="modal fade app-screenshot-modal" id="uypModal" tabindex="-1" aria-labelledby="uypModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header pb-0">
...
<div class="modal fade app-screenshot-modal" id="rrvmModal" tabindex="-1" aria-labelledby="rrvmModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header pb-0">
...
<div class="modal fade app-screenshot-modal" id="fandoraModal" tabindex="-1" aria-labelledby="fandoraModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header pb-0">
...
<div class="modal fade app-screenshot-modal" id="cctvModal" tabindex="-1" aria-labelledby="cctvModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header pb-0">
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-12">
                            ...
                            <p class="heading-info">Got a project on your mind! We're confidential listeners, eager to
                                collaborate.</p>
                            <img src="{{ asset('includes-frontend') }}/images/campaign/saas-camp-footer.webp"
                                alt="img" class="camp-footer-img">
                            ...
                            <div class="right-side bg-blue">
                                ...
                                <ul class="contact-list">
                                    ...
                                    <li>
                                        ...
                                        <div class="text">
                                            <span>Address</span>
                                            <p>Incorporated in the Republic of Singapore 10 Anson Road # 13-09
                                                International Plaza Singapore (079903)</p>
                                        </div>
                                    </li>
                                </ul>
