            ...
            <div class="col-lg-4 offset-lg-3 col-md-6">
                <div class="form-box">
                    ...
                    <form action="{{ route('campaign.store') }}" method="post" id="campaign-form" autocomplete="off">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="floatingInput3" placeholder="number" onkeypress="return /[0-9]/i.test(event.key)" onpaste="return false;" oncopy="return false;" minlength="7" maxlength="15" name="contact" />
