        ...
        <div class="row">
            <div class="col-12">
                <div class="text-center">
                    ...
                    <p class="heading-info mb-0 ">Don't be shy, say hello! We're your one-stop solution for demos,
                        support, and business solutions.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-6">
                <div class="box">
                    <img src="{{ asset('includes-frontend') }}/images/mumbai.svg" alt="Mumbai">
                    <h2>Seawoods, Mumbai</h2>
                    <p>Seawoods Grand Central, Tower, Office 511, 5th Floor, 1, Sector 40, Seawoods, Navi Mumbai,
            ...
            <div class="col-lg-4 col-md-6 col-6">
                <div class="box">
                    <img src="{{ asset('includes-frontend') }}/images/mumbai.svg" alt="Mumbai">
                    <h2>Lucknow</h2>
                    <p>HIG 39, Sector G, LDA Colony, Kanpur Road, Ashiyana Chouraha, Lucknow - 226012</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-6">
                <div class="box">
                    <img src="{{ asset('includes-frontend') }}/images/mumbai.svg" alt="Mumbai">
                    <h2>Ranchi</h2>
                    <p>Dr. Bhosale Gali, 191/A, Near Govind Tower, Harihar Singh Road, Bariyatu, Ranchi Jharkhand -
                        834009</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-6">
