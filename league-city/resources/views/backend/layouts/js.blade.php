...
<script language="JavaScript" src="{{ asset('includes-backend/js/jquery.dataTables.min.js') }}" type="text/javascript">
</script>
<script language="JavaScript" src="{{ asset('includes-backend/js/dataTables.bootstrap.min.js') }}"
    type="text/javascript"></script>
<script language="JavaScript" src="{{ asset('includes-backend/js/dataTables.responsive.min.js') }}"
    type="text/javascript"></script>

<script language="JavaScript" src="{{ asset('includes-backend/js/responsive.bootstrap.min.js') }}"
    type="text/javascript"></script>
...
@if (@$current_page == 'packages')
    <script>
        function addKeyPoints() {
            ...
            $('.key_points').append(
                '<div class="row mt-2"><div class="col-md-10"><input type="text" name="key_point[]" class="form-control p-2 text-dark" /></div><div class="col-md-2"> <button type="button" class="btn btn-danger  w-100"  onclick="deleteParentWorking(this)"><i class="fa fa-trash"></i></button> </div></div> </div>'
            );
        }
