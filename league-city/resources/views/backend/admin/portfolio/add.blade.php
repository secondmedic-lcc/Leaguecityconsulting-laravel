                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-2">
                            ...
                            <input type="file" class="form-control" required name="portfolio_image" onchange="readURL(this);" accept="image/*" />
                        </div>
                        <div class="col-md-2">
                        ...
                        <div class="col-md-2">
                            <img alt="Portfolio Profile" src="{{ asset('uploads/default.jpg')}}"  class="img-responsive mt-2 rounded bg-secondary p-2" width="100" height="auto" id="img_preview2" />
                        </div>
                        <div class="col-md-6">
