                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-2">
                            ...
                            <input type="text" class="form-control" name="subtitle"
                                value="{{ old('subtitle', $sector->subtitle) }}">
                        </div>

                        <div class="col-md-12 mb-2">
                            <label class="form-label" for="">Description</label>
                            <textarea name="description" class="form-control" rows="5" required>{{ old('description', $sector->description) }}</textarea>
                        </div>

                        <div class="col-md-6 mb-2">
                            <label class="form-label" for="">Button Text</label>
                            <input type="text" class="form-control" name="button_text"
                                value="{{ old('button_text', $sector->button_text) }}">
                        </div>

                        <div class="col-md-6 mb-2">
                            <label class="form-label" for="">Button Link</label>
                            <input type="url" class="form-control" name="button_link"
                                value="{{ old('button_link', $sector->button_link) }}">
                        </div>
                        ...
                        <div class="col-md-1 text-end col-4 mt-4 mt-md-0">
                            <img alt="Sector Image" src="{{ asset($sector->image ?? 'uploads/default.jpg') }}"
