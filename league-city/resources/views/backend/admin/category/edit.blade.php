                        ...
                        <div class="row">
                            <div class="col-md-4 mb-2">
                                ...
                                <input type="text" class="form-control" name="category_name"
                                    onkeypress="return /[A-Za-z ]/i.test(event.key)" required value="{{ $category->category_name }}" />
                            </div>
                            <div class="col-md-4 mb-2">
                            ...
                            <div class="col-md-2 mt-1">
                                <img alt="User Category" src="{{ asset($imgUrl);  }}" class="img-responsive rounded" width="100" height="auto" id="img_preview" />
                            </div>
