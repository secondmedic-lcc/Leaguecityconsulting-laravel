...
<div class="row">
    <div class="col-lg-12">
        ...
        <form action="{{ route('team-members.update', $team_member->id) }}" method="POST" autocomplete="off"
            ...
            <div class="card h-auto">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-2 col-4">
                            <img alt="Profile Preview" src="{{ $team_member->image ? asset($team_member->image) : asset('uploads/default.jpg') }}" class="img-responsive mt-2 rounded w-100" id="img_preview" />
                        </div> --}}
                        ...
                        <div class="col-md-2 col-4">
                            <img alt="Profile Preview" src="{{ $team_member->image ? asset($team_member->image) : asset('uploads/default.jpg') }}" 
