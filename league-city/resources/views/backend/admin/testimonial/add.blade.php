<div class="row">
    <div class="col-lg-12">
        ...
        <form action="{{ route('testimonials.store') }}" method="POST" autocomplete="off" enctype="multipart/form-data">
        @csrf
            <div class="card h-auto">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label class="form-label" for="">Show at Homepage</label>
                            <select class="form-control text-dark" name="show_at_homepage" required>
                                <option value="1" {{ old('show_at_homepage') == '1' ? 'selected' : '' }}>Yes</option>
