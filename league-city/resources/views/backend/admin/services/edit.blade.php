@empty(!$services)
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <form action="{{ url('admin/services') }}/{{ $services->id }}" method="POST" autocomplete="off"
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <textarea name="min_description" class="form-control text-dark" rows="3" required>{{ @$services->min_description }}</textarea>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for=""> Description</label>
                                <textarea name="description" id="description" class="form-control text-dark" rows="5" required>{{ @$services->description }}</textarea>
                            </div>
                            ...
                            <div class="col-md-2 col-4">
                                <img alt="Services Profile"
                                    src="{{ $services->image && $services->image != '' ? asset($services->image) : asset('uploads/default.jpg') }}"
                                    class="img-responsive mt-2 rounded w-100" height="auto" id="img_preview" />
                            </div>
