                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" name="heading" required value="{{ $products->heading; }}" />
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label" for="">Product Sub Heading</label>
                                <input type="text" class="form-control" name="sub_heading" required value="{{ $products->sub_heading; }}" />
                            </div>
