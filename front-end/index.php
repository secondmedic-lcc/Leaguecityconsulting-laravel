...
<div class="bg-dark">
                ...
                <div class="col-12">
                    ...
                    <div class="owl-carousel services-slider">
                        ...
                        <div class="item">
                            <div class="box">
                                <div class="images">
                                    <img src="includes/images/mobile-app-development.jpg" alt="">
                                </div>
                                <div class="content">
                        ...
                        <div class="item">
                            <div class="box">
                                <div class="images">
                                    <img src="includes/images/web-development.webp" alt="">
                                </div>
                                <div class="content">
                        ...
                        <div class="item">
                            <div class="box">
                                <div class="images">
                                    <img src="includes/images/custom-software-development.webp" alt="">
                                </div>
                                <div class="content">
                        ...
                        <div class="item">
                            <div class="box">
                                <div class="images">
                                    <img src="includes/images/ui-ux-development.webp" alt="">
                                </div>
                                <div class="content">
                        ...
                        <div class="item">
                            <div class="box">
                                <div class="images">
                                    <img src="includes/images/ecommerce-development.webp" alt="">
                                </div>
                                <div class="content">
                        ...
                        <div class="item">
                            <div class="box">
                                <div class="images">
                                    <img src="includes/images/graphic-designing.webp" alt="">
                                </div>
                                <div class="content">
                        ...
                        <div class="item">
                            <div class="box">
                                <div class="images">
                                    <img src="includes/images/cyber-security.webp" alt="">
                                </div>
                                <div class="content">
    ...
    <section class="recent-work section-padding pb-0" id="portfolio">
        ...
        <div class="owl-carousel work-slider">
            <div class="item">
                <div class="box" style="background-image: url('includes/images/secondmedic.jpg">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <img src="includes/images/secmed-white.png" class="logo" alt="SecondMedic">
            ...
            <div class="item">
                <div class="box" style="background-image: url('includes/images/showoffclicks.jpg">
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <img src="includes/images/showoffclicks.png" class="logo" alt="SecondMedic">
            ...
            <div class="item">
                <div class="box" style="background-image: url('includes/images/greensole.jpg">
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <img src="includes/images/greensole.png" class="logo" alt="Greensole">
