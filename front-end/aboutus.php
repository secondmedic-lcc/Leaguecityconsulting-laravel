...
<section class="page-banner section-padding" style="background-image: url('includes/images/aboutus-banner.jpg');">
    <div class="container">
        <div class="row">
            <div class="col-lg-7">
...
<section class="aboutus section-padding pb-0">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <img src="includes/images/aboutus.webp" class="w-100" alt="About Us">
            </div>
            <div class="col-lg-6">
